...
public class CreateAndPopulateKeyspace {
  ...
  public static void main(String[] args) {
    ...
    try {
      System.out.printf("Starting CreateAndPopulateKeyspace example%n");
      System.out.printf("Connecting to the cluster...%n");
      client.connect();
      System.out.printf("Creating the schema...%n");
      client.createSchema();
      System.out.printf("Loading the table...%n");
      client.loadData();
      System.out.printf("Querying the table...%n");
      client.querySchema();
  ...
  public void createSchema() {
    ...
    session.execute(
        "CREATE KEYSPACE IF NOT EXISTS simplex WITH replication "
            + "= {'class':'NetworkTopologyStrategy', 'replication_factor':3} AND TABLETS = {'enabled': true};");
